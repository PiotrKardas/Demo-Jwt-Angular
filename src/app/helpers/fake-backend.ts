...
export function fakeBackendFactory(backend: MockBackend, options: BaseRequestOptions) {
    ...
    let token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IlBpb3RyIEZvb2JhciIsImFkbWluIjp0cnVlfQ.giFVEGIvtYqaf1jkLZhG9vV7rkrvq76UWOuqE_CX-Ao';
